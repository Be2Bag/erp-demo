...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateBankAccountsDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/bank-accounts/list": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search term to filter bank accounts",
                        "name": "search",
                        "in": "query"
                    },
                    {
        ...
        "/v1/bank-accounts/{id}": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.BankAccountsDTO"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Bank Account Update Payload",
                        "name": "bankAccount",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateBankAccountsDTO"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateIncomeDTO"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateIncomeDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/transaction-category/create": {
            "post": {
        ...
        "/v1/transaction-category/{id}": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.TransactionCategoryDTO"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated Transaction Category data",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "dto.CreateTransactionCategoryDTO": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "ประเภทหมวดหมู่ (เช่น รายรับ, รายจ่าย)",
                    "type": "string"
                }
            }
        },
