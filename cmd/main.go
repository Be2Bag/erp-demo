...
// @host         dev-erp-demo.onrender.com
...
func main() {
	...
	app.Use(cors.New(cors.Config{
		AllowOrigins:     "http://localhost:5173,https://erp-demo-frontend.vercel.app,https://www.rkp-media.com,https://dev-erp-demo-frontend.vercel.app",
