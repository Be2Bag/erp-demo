...
type InComeService interface {
	...
	ListInComes(ctx context.Context, claims *dto.JWTClaims, page, size int, search string, sortBy string, sortOrder string, transactionCategoryID string, startDate string, endDate string, bankID string) (dto.Pagination, error)
